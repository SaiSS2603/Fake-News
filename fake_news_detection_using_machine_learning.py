...
Original file is located at
    https://colab.research.google.com/drive/13kdals9Vzzg-4321GDL1nMNgK1Dr2rRx
...
news = str(input("Enter the news to be ver"))
manual_testing(news)
...
with open('decision_tree_model.pkl', 'wb') as model_file2:
    pickle.dump(DT, model_file2)
